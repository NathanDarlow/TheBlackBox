<template>
<div>
    <h1 class="subheading grey--text mx-5 pt-12">Jobseeker LogIn</h1>
    <v-form @submit="login">
        <v-container>
            <v-row>
                ...
                <v-col cols="12" md="7" sm="6" class="mx-auto">
                    ...
                    <v-col class="d-flex align-center">
                        <v-spacer></v-spacer>
                        <nuxt-link to="/auth/register"><h3 class="grey--text">Dont Have An Account? <a href="javascript:void(0)" @click="navigateTo('jobseeker.registration')">Sign Up</a></h3></nuxt-link>
                        <v-spacer></v-spacer>
                    </v-col> 
                </v-form>
            </div>
