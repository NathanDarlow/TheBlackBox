        ...
        <v-container>
            <v-row>
                ...
                <v-col cols="12" md="7" sm="6" class="mx-auto">
                  <v-text-field
                    v-model="jobSeekerRegistration.firstName"
                    name="FirstName"
                ...
                <v-col cols="12" md="7" sm="6" class="mx-auto">
                  <v-text-field
                    v-model="jobSeekerRegistration.lastName"
                    name="LastName"
                    v-validate="'required|max:35'"
                    :counter="35"
                    :error-messages="errors.collect('name')"
        ...
        async submitFormValues(){
              try {
                const res = await RegisterService.jobseekerRegister({
                  firstName: this.jobSeekerRegistration.firstName,
                  lastName: this.jobSeekerRegistration.lastName,
